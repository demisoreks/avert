        ...
        <div class="container-fluid" style="height: 100vh;">
            ...
            <div class="row">
                <div class="col-md-2">
                    <div id="accordion-menu" style="margin-bottom: 10px;">
                        ...
                        @if (count(array_intersect($permissions, ['ControlRoom', 'Admin'])) != 0)
                        <div class="card">
                            ...
                            <div id="collapse-menu2" class="collapse @if (isset($open_menu) && $open_menu == 'panic') show @endif" aria-labelledby="heading-menu2" data-parent="#accordion-menu">
                                <div class="card-body">
                                    <nav class="nav flex-column">
                                        @if (count(array_intersect($permissions, ['ControlRoom'])) != 0)
                                        <a class="nav-link" href="{{ route('panic_requests.pending') }}">Pending Requests</a>
                                        @endif
                                        <a class="nav-link" href="{{ route('panic_requests.active') }}">Active Requests</a>
                                    </nav>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-12 justify-content-end text-right">
                    <div style="border-top: 1px solid #999; margin-top: 20px; padding: 10px 0;">Powered by <a href="https://halogensecurity.com" target="_blank">Halogen Group</a></div>
                </div>
            </div>
        </div>
    </body>
